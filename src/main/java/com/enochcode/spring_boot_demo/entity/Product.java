...
public class Product {
	...
	public java.util.List<ProductReview> getReviews() {
		return reviews;
	}

	public void setReviews(java.util.List<ProductReview> reviews) {
	...
	public Product(Long id, String name, Double price, String description,String category, String seller, Integer stock,
			 Double ratings,java.util.List<ProductImage>images) {
